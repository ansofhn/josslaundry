...
import pict3 from "../public/assets/pict3.svg";
...
const About_v3 = () => {
    return (
        ...
        <div className="container">
            <div>
            <div className="grid grid-cols-2 md:grid-cols-1 sm:mx-6 md:mx-16 xl:mx-20 2xl:mx-40">
                <div className="md:hidden mx-10 mt-6">
                    <Image src={pict3} className="rounded-xl" />
                </div>
                <div>
                <div className="mt-12 sm:mt-10 sm:mb-4 font-semibold text-center md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl text-maroon">
                    Halo, kami Joss Laundry
                </div>
                <div className="hidden sm:inline lg:mb-10 xl:mb-20 text-sm font-light text-center text-textColor">
                    Kami menawarkan jasa laundry dengan harga yang terjangkau dan  tetap menjaga kualitas sebagai prioritas utama. 
                    <br/>
                    Kami secara konsisten berupaya memberikan layanan terbaik untuk kepuasan pelanggan.
                </div>
                </div>
            </div>
            <div className="grid md:grid-cols-3 md:gap-6 sm:mt-6 lg:mt-0 lg:gap-x-10 lg:gap-y-16 xl:gap-20 p-4 sm:mx-6 md:mx-10 lg:mx-16 xl:mx-20 2xl:mx-40 bg-white">
                <div className="hidden md:block mt-8 lg:mt-0 px-32 md:p-0 md:h-full">
                <Image src={pict3} className="rounded-xl" />
                </div>
                <div className="my-auto md:col-span-2 text-center md:text-left lg:text-justify">
                <div className="text-sm lg:text-base leading-7 leading-relaxe">
                ...
                <div className="my-auto text-center md:text-left lg:text-justify">
                <p className="text-sm lg:text-base leading-7 leading-relaxe">
                ...
                <div className="p-0 mt-10 md:mt-0 md:col-span-2 overflow-hidden bg-gray-100 rounded-xl h-60 lg:h-96">
                <iframe
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 p-4 gap-10 lg:gap-20 sm:mx-6 md:mx-10 lg:mx-16 sm:mx-6 md:mx-10 lg:mx-16 xl:mx-20 2xl:mx-40 mt-4 lg:mt-10">
                ...
                <div className="2xl:mt-10 mb-4 text-center md:text-left font-semibold sm:text-2xl md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl">
