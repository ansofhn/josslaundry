...
export default function Feature() {
  return (
    <div className="container">
      <div className="mx-auto my-10 lg:my-20 md:my-14">
        ...
        <div className="grid grid-cols-2 m-6 text-center gap-x-10 gap-y-4 sm:gap-0 sm:grid-cols-4 md:mx-10 xl:mx-40 xl:mb-20">
          <div>
