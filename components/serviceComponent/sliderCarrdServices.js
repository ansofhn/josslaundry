            ...
            <SwiperSlide>
              <div className="relative inline-block conten-overlay">
                ...
                <Link href={"/pricelist#lainnya"}>
                  <div
                    className="absolute transition-all duration-300 ease-in w-full rounded-b h-11 left-0 bottom-1.5 bg-zinc-400/50 overlay-text"
                    style={{ cursor: "pointer" }}
                  >
                    <div className="absolute text-xl text-white -translate-x-1/2 -translate-y-1/2 top-2/4 left-2/4">
                      Ransel
                    </div>
                  </div>
                </Link>
