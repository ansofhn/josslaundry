...
export default function Service() {
  return (
    <div className="container">
      <div className="text-3xl font-bold text-center mb-14 text-maroon md:m-0">Layanan Kami</div>
      <div className="grid grid-cols-3 mx-40 h-72 md:mt-2 md:mb-14 md:mx-10 md:h-40 xl:mx-40">
        <div className="flex items-center justify-start">
          <Image src={express} />
        </div>
        <div className="mt-20 col-span-2 md:mt-14 xl:mt-20">
      ...
      <div className="grid grid-cols-3 mx-40 h-72 md:mt-16 md:mb-0 md:mx-10 md:h-52 xl:mx-40 xl:mt-20">
        <div className="mt-20 text-right col-span-2 md:mt-14 xl:mt-20">
      ...
      <div className="grid grid-cols-3 mx-40 h-72 md:mt-2 md:mb-30 md:mx-10 md:h-40 lg:mb-40 xl:mb-64 xl:mx-40 2xl:mt-20 xl:mb-18 ">
        ...
        <div className="mt-20 col-span-2 md:mt-18 xl:mt-20">
      ...
      <div className=" flex items-center justify-between py-6 mx-10 mt-28 mb-20 px-20 text-2xl font-semibold text-darkgreen bg-softblue rounded-2xl md:text-base md:py-2 md:px-10 md:mb-10 xl:text-xl">
