    ...
    <>
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 gap-6 mx-24 my-20">
          ...
          <div className="p-6 bg-gray-100 border-t-2 border-amber">
            <h2 className="mt-4 mb-2 font-medium">Reguler (2 Hari)</h2>
          ...
          <div className="p-6 bg-gray-100 border-t-2 border-amber">
            <h2 className="mt-4 mb-2 font-medium">Baju</h2>
            <div className="flex items-center justify-between text-sm font-light text-darkgreen">
              <div>Baju Kaos</div>
              <div>15,000</div>
            </div>
          ...
          <div className="p-6 bg-gray-100 border-t-2 border-amber">
            <h2 className="mt-4 mb-2 font-medium">Keset</h2>
            <div className="flex items-center justify-between text-sm font-light text-darkgreen">
              <div>Keset Kecil</div>
              <div>15,000</div>
            </div>
          ...
          <div className="p-6 bg-gray-100 border-t-2 border-amber">
            <h2 className="mt-4 mb-2 font-medium">Helm</h2>
            <div className="flex items-center justify-between text-sm font-light text-darkgreen">
              <div>Helm Biasa</div>
              <div>25,000</div>
            </div>
