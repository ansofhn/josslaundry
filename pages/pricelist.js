    ...
    <motion.div initial="initial" animate="animate" exit={{ opacity: 0 }}>
      ...
      <motion.div variants={Animation.stagger}>
        <div className="w-full mt-16 bg-gradient-to-tr from-orange-500 to-yellow-500">
          <motion.div variants={Animation.fadeInUp} className="container">
      ...
      >
        <motion.div variants={Animation.stagger}>
          <motion.div
            ...
            className="mb-4 text-2xl font-bold text-center mt-14 xl:text-3xl 2xl:text-4xl text-maroon"
          >
            Harga Lebih Lengkap
          </motion.div>
          <motion.div
            variants={Animation.fadeInUp}
            className="mb-20 text-base font-light text-center lg:text-lg text-textColor"
          >
          ...
          <motion.div
            variants={Animation.fadeInUp}
            className="grid gap-6 mx-4 md:grid-cols-2 md:mx-8 lg:mx-24 lg:my-20"
          >
